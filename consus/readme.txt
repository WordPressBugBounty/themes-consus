...
= How can I customize Consus? =

    To customize the Consus theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Consus WordPress theme, Copyright (C) 2021 ExtendThemes
Consus WordPress theme is licensed under GPL3.
...
- Images
  ...
  These assets are distributed under the CC0 License:
        ...
        resources/images/demo-video-cover.png
        License: CC0 1.0 Universal (CC0 1.0)
        
        resources/images/header-shapes/demo-video.mp4
        License: CC0 1.0 Universal (CC0 1.0)
