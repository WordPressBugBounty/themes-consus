...
$consus_theme_divider_style = array(
...
return array(
	'default_icon'                      => $consus_theme_svg_icons['fort-awesome'],
	'icons'                             => $consus_theme_svg_icons,
	'divider_style'                     => $consus_theme_divider_style,
	'lorem_ipsum'                       => $consus_lorem_ipsum,
	'edit_this_text_in_customizer'      => $consus_theme_click_pen_to_edit_title,
	'gradients'                         => $consus_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $consus_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $consus_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $consus_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'left',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $consus_gradients['front_header_default_overlay'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
							...
							'video'     => array(
								...
								'internalUrl' => get_template_directory_uri() . '/resources/images/demo-video.mp4',
								'poster'      =>
									array(
							...
							'image'     => array(
								array(
									'source'     => array(
										...
										'gradient' => $consus_gradients['night_fade'],
									),
									'attachment' => 'scroll',
								),
							),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $consus_theme_svg_icons['facebook-square'],
						'link_value' => 'https://www.facebook.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $consus_theme_svg_icons['instagram-square'],
						'link_value' => 'https://www.instagram.com/',
						'index'      => 1,
					),
					array(
						'icon'       => $consus_theme_svg_icons['youtube-play'],
						'link_value' => 'https://www.youtube.com/',
						'index'      => 2,
					),
					array(
						'icon'       => $consus_theme_svg_icons['reddit'],
	...
	'header'                            => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $consus_gradients['inner_header_default_overlay'],
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $consus_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $consus_theme_svg_icons['twitter'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $consus_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $consus_theme_svg_icons['vimeo'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					...
					array(
						'icon'       => $consus_theme_svg_icons['phone-square'],
						'text'       => '+400 098 765 432',
						'link_value' => '#',
						'index'      => 1,
					),
