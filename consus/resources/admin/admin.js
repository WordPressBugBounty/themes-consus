...
(function ($) {
  ...
  if (!window.consus_admin) {
    return;
  }

  var _window$consus_admin = window.consus_admin,
      builderStatusData = _window$consus_admin.builderStatusData,
      getStartedData = _window$consus_admin.getStartedData;
